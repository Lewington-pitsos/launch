$(function() {
  ...
  */
  ...
  var navManager = {
    ...
    addFirstTime: function(date, index, complete) {
      if (complete) {
        this.addToList(date, index, this.$completed);
      }
  ...
  */
  ...
  var reloadListener = {
    ...
    checkStorage: function() {
      console.log(`has Data: ${localStorage.getItem('hasData')}`);
