...
this["JST"]["cart"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<label for=\"cart_toggle\">"
    ...
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.albums : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</ul><p>$"
...
this["JST"]["form"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div id=\"album_new\"><h1>Add a new Album</h1><form action=\"/albums\" method=\"post\"><fieldset><dl><dt><label>Title</label></dt><dd><input type=\"text\" name=\"title\"></dd><dt><label>Artist</label></dt><dd><input type=\"text\" name=\"artist\"></dd><dt><label>Date</label></dt><dd><input type=\"text\" name=\"date\"></dd><dt><label>cover</label></dt><dd><input type=\"url\" name=\"cover\"></dd><dt><label>price</label></dt><dd><input type=\"text\" name=\"price\"></dd></dl></fieldset><fieldset class=\"actions\"><input type=\"submit\" value=\"create\"></fieldset></form></div>";
},"useData":true});

this["JST"]["index"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<h1>Albums</h1><ul></ul><footer><a class=\"button\" href=\"/albums/new\">Add new Album</a></footer>";
},"useData":true});